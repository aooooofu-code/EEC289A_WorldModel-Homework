...
class StudentWorldModel(nn.Module):
    def __init__(
        ...
        self.base_head = nn.Linear(hidden_dim, obs_dim)
    ...
    def forward(self, obs_norm: torch.Tensor, act_norm: torch.Tensor, hidden=None):
        ...
        base_delta = self.base_head(feat)
        residual_delta = self.residual_head(feat)

        raw_delta = base_delta + 0.85 * residual_delta
